...
void show_contacts(GtkWidget *main_grid)
{
    ...
    main_form.box_contact = GTK_WIDGET(gtk_builder_get_object(builder, "box_contact"));
    ...
    GtkWidget *arr[] = {main_form.left_content[1], contacts_info_panel, main_form.box_contact, box_add_new, add_new_contact, NULL};
